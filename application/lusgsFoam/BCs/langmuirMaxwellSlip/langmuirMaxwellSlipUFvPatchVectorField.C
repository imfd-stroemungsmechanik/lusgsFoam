...
#include "langmuirMaxwellSlipUFvPatchVectorField.H"
...
Foam::langmuirMaxwellSlipUFvPatchVectorField::langmuirMaxwellSlipUFvPatchVectorField
(
    const fvPatch& p,
...
Foam::langmuirMaxwellSlipUFvPatchVectorField::langmuirMaxwellSlipUFvPatchVectorField
(
    const langmuirMaxwellSlipUFvPatchVectorField& mspvf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
void Foam::langmuirMaxwellSlipUFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::langmuirMaxwellSlipUFvPatchVectorField::write(Ostream& os) const
{
...
namespace Foam
{
    ...
    (
        fvPatchVectorField,
        langmuirMaxwellSlipUFvPatchVectorField
    );
}
