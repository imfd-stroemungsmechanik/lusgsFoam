...
void Foam::LUSGS::sweep()
{
    ...
    Info<< "LUSGS:  Solving for rho,  " 
        << "Initial residual = 1, "
        << "Final residual = " << finalRes_rho/initialRes_rho << ", No Iterations 1" << nl;
    Info<< "LUSGS:  Solving for rhoU, " 
        << "Initial residual = 1, "
        << "Final residual = " << finalRes_rhoU/initialRes_rhoU << ", No Iterations 1" << nl;
    Info<< "LUSGS:  Solving for rhoE, "
        << "Initial residual = 1, "
        << "Final residual = " << finalRes_rhoE/initialRes_rhoE << ", No Iterations 1" << nl;
